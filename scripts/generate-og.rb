...
cmd = [
  ...
  "-fill", "rgba(245,158,11,0.055)", "-stroke", "none",
  "-draw", "circle 600,-330 900,-330",
  "-fill", amber, "-font", "JetBrains-Mono-Regular", "-pointsize", "30",
  "-annotate", "+76+105", ">_",
  "-fill", text, "-font", "Inter-Regular", "-pointsize", point_size.to_s,
  "-interline-spacing", "-4", "-annotate", "+76+190", lines.join("\n"),
  "-stroke", border, "-strokewidth", "1", "-draw", "line 76,505 1124,505",
  "-stroke", "none", "-fill", muted, "-font", "JetBrains-Mono-Regular", "-pointsize", "18",
  "-annotate", "+76+558", "JOSH HOLTZ  /  JOSHHOLTZ.COM",
  "-stroke", amber, "-strokewidth", "2", "-fill", "none",
  "-draw", "roundrectangle 1034,530 1124,574 7,7",
  "-stroke", "none", "-fill", amber, "-font", "JetBrains-Mono-Regular", "-pointsize", "17",
